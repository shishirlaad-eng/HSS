...
// HSS UK Membership Management System â€” Members Mock Data
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Karyakartas â€” members who hold a sangh responsibility â”€â”€â”€â”€â”€
// Only the members listed here have a Responsibility (Type + Level)
// assigned. Everyone else has none â€” this drives the "Karyakartas"
...
export interface MemberCompliance {
  ...
  safeguardingTraining?: CertStatus;
}
...
// â”€â”€ Masters Cascade Data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const FILLER_NOTES = [
  ...
  'Enjoys community Karyakrams and helps with Karyakram setup.',
...
// â”€â”€ Mock Data â€” 10 members with full variety â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const rawMockMembers: Member[] = [
  {
    ...
    compliance: { dbs: 'Approved', firstAid: 'Certified', parentalConsent: 'n/a' },
    dbsRef: 'DBS-2024-001',
  ...
  },
  {
    ...
    compliance: { dbs: 'Approved', firstAid: 'Expired', parentalConsent: 'n/a' },
    dbsRef: 'DBS-2023-002',
    eventsAttended: 8,
  ...
  },
  {
    ...
    compliance: { dbs: 'Pending', firstAid: 'Expired', parentalConsent: 'n/a' },
  ...
  },
  {
    ...
    compliance: { dbs: 'Approved', firstAid: 'Certified', parentalConsent: 'pending' },
    eventsAttended: 0,
  ...
  },
  {
    ...
    compliance: { dbs: 'Pending', firstAid: 'Certified', parentalConsent: 'n/a' },
  ...
  },
  {
    ...
    compliance: { dbs: 'Approved', firstAid: 'Certified', parentalConsent: 'granted' },
    eventsAttended: 3,
  ...
  },
  {
    ...
    activityCentre: 'Harrow Activity Centre',
    status: 'pending',
    registrationDate: '2025-06-02T09:00:00Z',
    compliance: { dbs: 'Pending', firstAid: 'N/A', parentalConsent: 'n/a' },
    eventsAttended: 0,
    shakhaSessionsAttended: 0,
  },
  {
    ...
    activityCentre: 'Coventry Activity Centre',
    status: 'pending',
    registrationDate: '2025-06-05T10:15:00Z',
    compliance: { dbs: 'Pending', firstAid: 'N/A', parentalConsent: 'n/a' },
    eventsAttended: 0,
    shakhaSessionsAttended: 0,
  },
  {
    ...
    activityCentre: 'Manchester Central Activity Centre',
    status: 'pending',
    registrationDate: '2025-06-08T11:30:00Z',
    compliance: { dbs: 'Pending', firstAid: 'N/A', parentalConsent: 'n/a' },
    eventsAttended: 0,
    shakhaSessionsAttended: 0,
  },
  {
    ...
    activityCentre: 'Leeds North Activity Centre',
    status: 'pending',
    registrationDate: '2025-06-10T08:45:00Z',
    compliance: { dbs: 'Pending', firstAid: 'N/A', parentalConsent: 'n/a' },
    eventsAttended: 0,
    shakhaSessionsAttended: 0,
  },
  {
    ...
    activityCentre: 'Wembley Activity Centre',
    status: 'pending',
    registrationDate: '2025-06-12T13:00:00Z',
    compliance: { dbs: 'Pending', firstAid: 'N/A', parentalConsent: 'n/a' },
    eventsAttended: 0,
    shakhaSessionsAttended: 0,
  },
  {
    ...
    activityCentre: 'Birmingham East Activity Centre',
    status: 'pending',
    registrationDate: '2025-06-15T09:20:00Z',
    compliance: { dbs: 'Pending', firstAid: 'N/A', parentalConsent: 'n/a' },
    eventsAttended: 0,
    shakhaSessionsAttended: 0,
  },
  {
    ...
    phone: '+44 7700 200017',
    dateOfBirth: '1969-12-08',
    gender: 'male',
    jobTitle: 'Vyavestha',
    orgRole: 'Member',
    country: 'HSS UK',
    ...
    activityCentre: 'Manchester Central Activity Centre',
    status: 'pending',
    registrationDate: '2025-06-18T14:10:00Z',
    compliance: { dbs: 'Pending', firstAid: 'N/A', parentalConsent: 'n/a' },
    eventsAttended: 0,
    shakhaSessionsAttended: 0,
  },
  {
    ...
    activityCentre: 'Harrow Activity Centre',
    status: 'pending',
    registrationDate: '2025-06-20T10:50:00Z',
    compliance: { dbs: 'Pending', firstAid: 'N/A', parentalConsent: 'n/a' },
    eventsAttended: 0,
    shakhaSessionsAttended: 0,
  },
  {
    ...
    activityCentre: 'Leeds North Activity Centre',
    status: 'pending',
    registrationDate: '2025-06-22T15:30:00Z',
    compliance: { dbs: 'Pending', firstAid: 'N/A', parentalConsent: 'n/a' },
    eventsAttended: 0,
    shakhaSessionsAttended: 0,
  },
  ...
  { id:'WBL-011', memberType:'adult',  name:'Sachin Rao',         email:'sachin.rao@hssuk.org',         dateOfBirth:'2001-02-28', gender:'male',   jobTitle:'Shikshak',               orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-07-08T11:00:00Z', compliance:{dbs:'Pending', firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:9,  shakhaSessionsAttended:33 },
  { id:'WBL-012', memberType:'adult',  name:'Lata Krishnan',      email:'lata.krishnan@hssuk.org',      dateOfBirth:'1972-11-17', gender:'female', jobTitle:'Sewa',                   orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2020-06-15T09:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:10, shakhaSessionsAttended:40 },
  { id:'WBL-013', memberType:'adult',  name:'Deepak Bose',        email:'deepak.bose@hssuk.org',        dateOfBirth:'1974-03-28', gender:'male',   jobTitle:'Karyawaha',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:14, shakhaSessionsAttended:55 },
  { id:'WBL-014', memberType:'adult',  name:'Geeta Menon',        email:'geeta.menon@hssuk.org',        dateOfBirth:'1944-06-12', gender:'female', jobTitle:'Jyestha(a)',             orgRole:'Senior Member',  country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2023-09-18T11:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:3,  shakhaSessionsAttended:8  },
  { id:'WBL-015', memberType:'adult',  name:'Kiran Trivedi',      email:'kiran.trivedi@hssuk.org',      dateOfBirth:'2002-09-18', gender:'male',   jobTitle:'Prachaar',               orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2023-03-10T09:00:00Z', compliance:{dbs:'Pending', firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:5,  shakhaSessionsAttended:20 },
  { id:'WBL-016', memberType:'adult',  name:'Sunita Pandey',      email:'sunita.pandey@hssuk.org',      dateOfBirth:'2003-04-07', gender:'female', jobTitle:'Sewa',                   orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2022-08-25T10:30:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:4,  shakhaSessionsAttended:16 },
  { id:'WBL-017', memberType:'adult',  name:'Arun Chatterjee',    email:'arun.chatterjee@hssuk.org',    dateOfBirth:'1976-09-05', gender:'male',   jobTitle:'Vyavestha',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:7,  shakhaSessionsAttended:27 },
  { id:'WBL-018', memberType:'adult',  name:'Maya Saxena',        email:'maya.saxena@hssuk.org',        dateOfBirth:'1978-06-19', gender:'female', jobTitle:'Sewa',                   orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-07-08T11:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:9,  shakhaSessionsAttended:36 },
  { id:'WBL-019', memberType:'adult',  name:'Vivek Mishra',       email:'vivek.mishra@hssuk.org',       dateOfBirth:'2004-12-22', gender:'male',   jobTitle:'SSV',                    orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2023-03-10T09:00:00Z', compliance:{dbs:'Pending', firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:6,  shakhaSessionsAttended:23 },
  { id:'WBL-020', memberType:'adult',  name:'Rekha Pillai',       email:'rekha.pillai@hssuk.org',       dateOfBirth:'1980-01-30', gender:'female', jobTitle:'Sewa',                   orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2020-06-15T09:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:8,  shakhaSessionsAttended:32 },
  { id:'WBL-021', memberType:'adult',  name:'Gaurav Tiwari',      email:'gaurav.tiwari@hssuk.org',      dateOfBirth:'2005-06-30', gender:'male',   jobTitle:'Vistaar',                orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2023-09-18T11:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:5,  shakhaSessionsAttended:19 },
  ...
  { id:'WBL-024', memberType:'adult',  name:'Kavita Agarwal',     email:'kavita.agarwal@hssuk.org',     dateOfBirth:'2007-08-03', gender:'female', jobTitle:'Shakha / Activity center',orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2024-01-05T09:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:3,  shakhaSessionsAttended:14 },
  ...
  { id:'WBL-033', memberType:'adult',  name:'Hemant Arora',       email:'hemant.arora@hssuk.org',       dateOfBirth:'1986-10-13', gender:'male',   jobTitle:'Mukhya Shikshak',        orgRole:'Shakha Teacher', country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2020-06-15T09:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:12, shakhaSessionsAttended:46 },
  { id:'WBL-034', memberType:'adult',  name:'Indu Ghosh',         email:'indu.ghosh@hssuk.org',         dateOfBirth:'1947-11-03', gender:'female', jobTitle:'Jyestha(a)',             orgRole:'Senior Member',  country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2024-01-05T09:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:2,  shakhaSessionsAttended:6  },
  { id:'WBL-035', memberType:'child',  name:'Ishaan Naik',        email:'ishaan.naik@hssuk.org',        dateOfBirth:'2015-06-15', gender:'male',   jobTitle:'Shishu',                 orgRole:'Youth Member',   country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2025-01-15T09:00:00Z', compliance:{dbs:'Pending', firstAid:'Expired', parentalConsent:'granted'}, eventsAttended:0,  shakhaSessionsAttended:5  },
  ...
  { id:'WBL-039', memberType:'adult',  name:'Ganesh Nair',        email:'ganesh.nair@hssuk.org',        dateOfBirth:'1988-04-02', gender:'male',   jobTitle:'Ghatnayak',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:10, shakhaSessionsAttended:39 },
  { id:'WBL-040', memberType:'adult',  name:'Pritha Joshi',       email:'pritha.joshi@hssuk.org',       dateOfBirth:'2001-02-28', gender:'female', jobTitle:'Shikshak',               orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2023-03-10T09:00:00Z', compliance:{dbs:'Pending', firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:3,  shakhaSessionsAttended:13 },
  ...
  { id:'WBL-042', memberType:'adult',  name:'Smita Gupta',        email:'smita.gupta@hssuk.org',        dateOfBirth:'1990-08-27', gender:'female', jobTitle:'Sewa',                   orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-07-08T11:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:8,  shakhaSessionsAttended:33 },
  { id:'WBL-043', memberType:'adult',  name:'Chetan Mehta',       email:'chetan.mehta@hssuk.org',       dateOfBirth:'1992-03-16', gender:'male',   jobTitle:'Sanghchalak',            orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:9,  shakhaSessionsAttended:36 },
  { id:'WBL-044', memberType:'youth',  name:'Payal Verma',        email:'payal.verma@hssuk.org',        dateOfBirth:'2014-04-28', gender:'female', jobTitle:'Kishor(i)',              orgRole:'Youth Member',   country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2025-01-15T09:00:00Z', compliance:{dbs:'Approved',firstAid:'Expired', parentalConsent:'granted'}, eventsAttended:1,  shakhaSessionsAttended:7  },
  { id:'WBL-045', memberType:'adult',  name:'Bhavesh Iyer',       email:'bhavesh.iyer@hssuk.org',       dateOfBirth:'2003-04-07', gender:'male',   jobTitle:'Prachaar',               orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2023-09-18T11:00:00Z', compliance:{dbs:'Pending', firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:4,  shakhaSessionsAttended:17 },
  { id:'WBL-046', memberType:'adult',  name:'Chanchal Rao',       email:'chanchal.rao@hssuk.org',       dateOfBirth:'2004-12-22', gender:'female', jobTitle:'Sewa',                   orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2024-01-05T09:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:3,  shakhaSessionsAttended:14 },
  { id:'WBL-047', memberType:'adult',  name:'Dilip Pillai',       email:'dilip.pillai@hssuk.org',       dateOfBirth:'1966-02-14', gender:'male',   jobTitle:'Vyavestha',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2022-02-14T09:30:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:6,  shakhaSessionsAttended:22 },
  { id:'WBL-048', memberType:'adult',  name:'Falak Reddy',        email:'falak.reddy@hssuk.org',        dateOfBirth:'2005-06-30', gender:'female', jobTitle:'Tarun(i)',               orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2023-03-10T09:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:5,  shakhaSessionsAttended:19 },
  { id:'WBL-049', memberType:'adult',  name:'Gopal Bose',         email:'gopal.bose@hssuk.org',         dateOfBirth:'1950-02-18', gender:'male',   jobTitle:'Jyestha(a)',             orgRole:'Senior Member',  country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2023-09-18T11:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:2,  shakhaSessionsAttended:5  },
  { id:'WBL-050', memberType:'adult',  name:'Harsha Trivedi',     email:'harsha.trivedi@hssuk.org',     dateOfBirth:'2006-01-11', gender:'female', jobTitle:'Sewa',                   orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2024-01-05T09:00:00Z', compliance:{dbs:'Pending', firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:4,  shakhaSessionsAttended:16 },
  ...
  { id:'WBL-058', memberType:'adult',  name:'Padma Dubey',        email:'padma.dubey@hssuk.org',        dateOfBirth:'1952-08-25', gender:'female', jobTitle:'Jyestha(a)',             orgRole:'Senior Member',  country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2024-01-05T09:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:1,  shakhaSessionsAttended:4  },
  { id:'WBL-059', memberType:'adult',  name:'Prakash Banerjee',   email:'prakash.banerjee@hssuk.org',   dateOfBirth:'1972-11-17', gender:'male',   jobTitle:'Karyawaha',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:11, shakhaSessionsAttended:42 },
  { id:'WBL-060', memberType:'adult',  name:'Revati Agarwal',     email:'revati.agarwal@hssuk.org',     dateOfBirth:'1998-03-25', gender:'female', jobTitle:'Sewa',                   orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2022-08-25T10:30:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:4,  shakhaSessionsAttended:18 },
  { id:'WBL-061', memberType:'adult',  name:'Sanjeev Chatterjee', email:'sanjeev.chatterjee@hssuk.org', dateOfBirth:'1974-03-28', gender:'male',   jobTitle:'Mukhya Shikshak',        orgRole:'Shakha Teacher', country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2020-06-15T09:00:00Z', compliance:{dbs:'Pending', firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:12, shakhaSessionsAttended:47 },
  { id:'WBL-062', memberType:'adult',  name:'Savitri Das',        email:'savitri.das@hssuk.org',        dateOfBirth:'1955-05-07', gender:'female', jobTitle:'Jyestha(a)',             orgRole:'Senior Member',  country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2023-09-18T11:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:2,  shakhaSessionsAttended:7  },
  ...
  { id:'WBL-067', memberType:'adult',  name:'Vijay Khanna',       email:'vijay.khanna@hssuk.org',       dateOfBirth:'1976-09-05', gender:'male',   jobTitle:'Ghatnayak',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:8,  shakhaSessionsAttended:32 },
  ...
  { id:'WBL-086', memberType:'adult',  name:'Indumati Joshi',     email:'indumati.joshi@hssuk.org',     dateOfBirth:'1962-06-08', gender:'female', jobTitle:'Jyestha(a)',             orgRole:'Senior Member',  country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2025-01-15T09:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:1,  shakhaSessionsAttended:3  },
  ...
  { id:'WBL-091', memberType:'adult',  name:'Laxman Shah',        email:'laxman.shah@hssuk.org',        dateOfBirth:'1986-10-13', gender:'male',   jobTitle:'Mukhya Shikshak',        orgRole:'Shakha Teacher', country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:11, shakhaSessionsAttended:43 },
  ...
  { id:'WBL-103', memberType:'adult',  name:'Trivikram Mishra',   email:'trivikram.mishra@hssuk.org',   dateOfBirth:'1966-02-14', gender:'male',   jobTitle:'Karyawaha',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Pending', firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:10, shakhaSessionsAttended:39 },
  ...
  { id:'WBL-107', memberType:'adult',  name:'Vishnu Banerjee',    email:'vishnu.banerjee@hssuk.org',    dateOfBirth:'1970-04-09', gender:'male',   jobTitle:'Sanghchalak',            orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:9,  shakhaSessionsAttended:35 },
  ...
  { id:'WBL-115', memberType:'adult',  name:'Bharat Khanna',      email:'bharat.khanna@hssuk.org',      dateOfBirth:'1974-03-28', gender:'male',   jobTitle:'Ghatnayak',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:10, shakhaSessionsAttended:38 },
  ...
  { id:'WBL-119', memberType:'adult',  name:'Devraj Chopra',      email:'devraj.chopra@hssuk.org',      dateOfBirth:'1976-09-05', gender:'male',   jobTitle:'Mukhya Shikshak',        orgRole:'Shakha Teacher', country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:11, shakhaSessionsAttended:43 },
  ...
  { id:'WBL-127', memberType:'adult',  name:'Hardev Thakkar',     email:'hardev.thakkar@hssuk.org',     dateOfBirth:'1950-02-18', gender:'male',   jobTitle:'Jyestha(a)',             orgRole:'Senior Member',  country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2024-07-22T10:00:00Z', compliance:{dbs:'Pending', firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:2,  shakhaSessionsAttended:5  },
  { id:'WBL-128', memberType:'adult',  name:'Ila Upadhyay',       email:'ila.upadhyay@hssuk.org',       dateOfBirth:'1982-12-08', gender:'female', jobTitle:'Sewa',                   orgRole:'Member',         country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-07-08T11:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:7,  shakhaSessionsAttended:27 },
  { id:'WBL-129', memberType:'adult',  name:'Indrajit Vyas',      email:'indrajit.vyas@hssuk.org',      dateOfBirth:'1984-05-24', gender:'male',   jobTitle:'Karyawaha',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:9,  shakhaSessionsAttended:34 },
  ...
  { id:'WBL-133', memberType:'adult',  name:'Kamlesh Singh',      email:'kamlesh.singh@hssuk.org',      dateOfBirth:'1986-10-13', gender:'male',   jobTitle:'Vyavestha',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:8,  shakhaSessionsAttended:31 },
  ...
  { id:'WBL-145', memberType:'adult',  name:'Rajiv Trivedi',      email:'rajiv.trivedi@hssuk.org',      dateOfBirth:'1992-03-16', gender:'male',   jobTitle:'Mukhya Shikshak',        orgRole:'Shakha Teacher', country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:10, shakhaSessionsAttended:38 },
  ...
  { id:'WBL-169', memberType:'adult',  name:'Eshwar Chopra',      email:'eshwar.chopra@hssuk.org',      dateOfBirth:'1978-06-19', gender:'male',   jobTitle:'Karyawaha',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:9,  shakhaSessionsAttended:34 },
  ...
  { id:'WBL-176', memberType:'adult',  name:'Harish Samant',      email:'harish.samant@hssuk.org',      dateOfBirth:'1980-01-30', gender:'male',   jobTitle:'Mukhya Shikshak',        orgRole:'Shakha Teacher', country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:10, shakhaSessionsAttended:38 },
  ...
  { id:'WBL-179', memberType:'adult',  name:'Jitendra Vyas',      email:'jitendra.vyas@hssuk.org',      dateOfBirth:'1982-12-08', gender:'male',   jobTitle:'Sanghchalak',            orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-07-08T11:00:00Z', compliance:{dbs:'Pending', firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:8,  shakhaSessionsAttended:30 },
  ...
  { id:'WBL-188', memberType:'adult',  name:'Mahesh Rao',         email:'mahesh.rao@hssuk.org',         dateOfBirth:'1986-10-13', gender:'male',   jobTitle:'Ghatnayak',              orgRole:'Volunteer',      country:'HSS UK', region:'London & South East', town:'Wembley', activityCentre:'Wembley Activity Centre', status:'active', registrationDate:'2021-01-20T10:00:00Z', compliance:{dbs:'Approved',firstAid:'Certified',parentalConsent:'n/a'}, eventsAttended:9,  shakhaSessionsAttended:34 },
