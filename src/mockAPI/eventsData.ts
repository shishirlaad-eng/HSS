...
export const mockParticipants: Record<string, EventParticipant[]> = {
  ...
  'EVT-119': [
    { memberId: 'MBR-001', name: 'Arjun Sharma',    email: 'arjun.sharma@example.com',  phone: '+44 7711 234567', memberType: 'adult', rsvp: 'going', ticketTypeId: 'PC-119-1', ticketTypeLabel: 'Adult' },
    { memberId: 'MBR-002', name: 'Priya Patel',     email: 'priya.patel@example.com',   phone: '+44 7722 345678', memberType: 'adult', rsvp: 'going', ticketTypeId: 'PC-119-1', ticketTypeLabel: 'Adult' },
    { memberId: 'MBR-003', name: 'Rahul Mehta',     email: 'rahul.mehta@example.com',   phone: '+44 7733 456789', memberType: 'adult', rsvp: 'going', ticketTypeId: 'PC-119-1', ticketTypeLabel: 'Adult', isCoordinator: true, checkedIn: true, checkedInAt: '2026-10-24T18:10:00Z' },
    { memberId: 'WBL-004', name: 'Kavya Reddy',     email: 'kavya.reddy@hssuk.org',      phone: '+44 7700 100004', memberType: 'teen',  rsvp: 'going', ticketTypeId: 'PC-119-2', ticketTypeLabel: 'Child' },
    { memberId: 'MBR-006', name: 'Ananya Joshi',    email: 'ananya.joshi@example.com',  phone: '+44 7766 789012', memberType: 'adult', rsvp: 'requested', ticketTypeId: 'PC-119-1', ticketTypeLabel: 'Adult' },
    { memberId: 'MBR-008', name: 'Kavita Nair',     email: 'kavita.nair@example.com',   phone: '+44 7788 901234', memberType: 'adult', rsvp: 'denied' },
  ],
  'EVT-120': [
    ...
    { memberId: 'MBR-013', name: 'Rakesh Iyer',     email: 'rakesh.iyer@example.com',   phone: '+44 7700 200013', memberType: 'adult', rsvp: 'going', waitlisted: true },
    { memberId: 'MBR-014', name: 'Kavya Reddy',     email: 'kavya.reddy@example.com',   phone: '+44 7700 200014', memberType: 'adult', rsvp: 'requested' },
  ],
};
...
export const mockEvents: Event[] = [
  ...
  },
  {
    ...
    locationType: 'physical',
    venueAddress: 'Wembley Activity Centre, Forty Avenue, Wembley, HA9 8JX',
    startDate: '2026-10-24T17:00:00Z',
    endDate: '2026-10-24T21:00:00Z',
    createdDate: '2026-08-01T09:00:00Z',
    lastUpdated: '2026-08-01T09:00:00Z',
    paymentType: 'paid',
    price: 12,
    priceCategories: [
      { id: 'PC-119-1', label: 'Adult', price: 12 },
      { id: 'PC-119-2', label: 'Child', price: 6 },
    ],
    capacity: 250,
    donationEnabled: true,
    donationDescription: 'Support the Diwali Mela programme with an optional donation on top of your ticket price.',
    donationAmounts: [10, 25, 50],
    description: 'An evening Diwali celebration with lights, stalls, cultural performances, and festive food for the whole Wembley Shakha community.',
    metrics: {
      going: 4,
      maybe: 1,
      notGoing: 0,
  ...
  },
  {
    ...
    capacity: 40,
    waitlistEnabled: true,
    description: 'An early-morning fitness bootcamp for Yuva members — circuit training, drills, and conditioning led by a certified instructor.',
    metrics: {
      going: 2,
      maybe: 0,
      notGoing: 0,
