...
export const mockRoles: Role[] = [
  ...
  // 1. Super Admin ─ full access to everything (only role with Settings, RBAC, Audit Logging)
  {
    ...
    permissions: {
      ...
      reports:       ["members_view", "members_export", "events_view", "events_export", "attendance_view", "attendance_export", "donations_view", "donations_export", "refunds_view", "refunds_export", "karyakarta_view", "karyakarta_export", "ayu_shreni_view", "ayu_shreni_export", "myhss_role_view", "myhss_role_export", "shakha_directory_view", "shakha_directory_export"],
